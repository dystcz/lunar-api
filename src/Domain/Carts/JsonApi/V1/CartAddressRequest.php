...
class CartAddressRequest extends AddressRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'shipping_option.string' => __('lunar-api::validations.addresses.shipping_option.string'),
            'address_type.required' => __('lunar-api::validations.addresses.address_type.required'),
            'address_type.string' => __('lunar-api::validations.addresses.address_type.string'),
            'address_type.in' => __('lunar-api::validations.addresses.address_type.in', [
                'types' => implode(', ', [
                    AddressType::SHIPPING->value,
                    AddressType::BILLING->value,
                ]),
