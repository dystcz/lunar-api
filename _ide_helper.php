...
')
     ...
     */ 
         ...
         * @param mixed $isRecursiveStep
         * @static 
         */ 
        public static function permutate($setTuples, $isRecursiveStep = false)
        {
                        return \Illuminate\Support\Arr::permutate($setTuples, $isRecursiveStep);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \Lunar\LunarServiceProvider::boot()
         * @param mixed $string
         * @static 
         */ 
        public static function handle($string)
        {
                        return \Illuminate\Support\Str::handle($string);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \Lunar\Models\Order::observe()
         * @static 
         */ 
         ...
         * 
         *
         * @see \Lunar\Models\Order::registerSearchableMacros()
         * @static 
         */ 
     ...
     */ 
        ...
        {
                        /** @var \Cartalyst\Converter\Converter $instance */
         ...
         * @static 
         */ 
        public static function format($measurement = null)
        {
                        /** @var \Cartalyst\Converter\Converter $instance */
                        return $instance->format($measurement);
        }
                    /**
        ...
        {
                        /** @var \Cartalyst\Converter\Converter $instance */
                        return $instance->getMeasurements();
        }
                    /**
         ...
         * @static 
         */ 
        public static function setMeasurements($measurements = [])
        {
                        /** @var \Cartalyst\Converter\Converter $instance */
                        return $instance->setMeasurements($measurements);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getMeasurement($measurement, $default = null)
        {
                        /** @var \Cartalyst\Converter\Converter $instance */
                        return $instance->getMeasurement($measurement, $default);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \Lunar\LunarServiceProvider::registerBlueprintMacros()
         * @static 
         */ 
        public static function scheduling()
        {
                        return \Illuminate\Database\Schema\Blueprint::scheduling();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Database\Schema\Blueprint::dimensions();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function userForeignKey($field_name = 'user_id', $nullable = false)
        {
                        return \Illuminate\Database\Schema\Blueprint::userForeignKey($field_name, $nullable);
        }
...
namespace  { 
            ...
            class PDF extends \Barryvdh\DomPDF\Facade\Pdf {}
            class Converter extends \Cartalyst\Converter\Laravel\Facades\Converter {}
            ...
            class LunarApi extends \Dystcz\LunarApi\LunarApiFacade {}
